...
TriggerEvent('es:addGroupCommand', 'car', 'admin', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"car\" :: User `" .. target.getIdentifier() .. "` created car `" .. args[1] .. "`")
  end)
end, function(source, args, user)
  TriggerClientEvent('chatMessage', source, "SYSTEM", { 255, 0, 0 }, "Insufficient Permissions.")
...
TriggerEvent('es:addGroupCommand', 'dv', 'mod', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"dv\" :: User `" .. target.getIdentifier() .. "` deleted a car.")
  end)
end, function(source, args, user)
  TriggerClientEvent('chatMessage', source, "SYSTEM", { 255, 0, 0 }, "Insufficient Permissions.")
...
TriggerEvent('es:addGroupCommand', 'givemoney', 'admin', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"givemoney\" :: User `" .. target.getIdentifier() .. "` gave `" .. GetPlayerName(args[1]) .. "` money: " .. amount)
  end)
...
TriggerEvent('es:addGroupCommand', 'giveaccountmoney', 'admin', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"giveaccountmoney\" :: User `" .. target.getIdentifier() .. "` gave `" .. GetPlayerName(args[1]) .. "` (" .. account .. ") money: " .. amount)
  end)
...
TriggerEvent('es:addGroupCommand', 'giveitem', 'admin', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"giveitem\" :: User `" .. target.getIdentifier() .. "` gave `" .. GetPlayerName(args[1]) .. "` item `" .. item .. "` (" .. count .. ")")
  end)
...
TriggerEvent('es:addGroupCommand', 'giveweapon', 'admin', function(source, args, user)
  ...
  TriggerEvent("es:getPlayerFromId", source, function(target)
    TriggerEvent("discord_bot:cmd_log", "CHAT_CMD  :: \"giveweapon\" :: User `" .. target.getIdentifier() .. "` gave `" .. GetPlayerName(args[1]) .. "` weapon `" .. weaponName .. "`")
  end)
