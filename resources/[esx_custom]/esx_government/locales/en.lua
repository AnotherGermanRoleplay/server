Locales['en'] = {
  ...
  ['box'] = 'box',
  ['cash'] = 'Box of cash',
  ['government_animations'] = 'Government Animations',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['government_stock'] = 'Government Stock',
  -- Misc
