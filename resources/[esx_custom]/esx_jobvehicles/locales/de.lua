Locales['de'] = {
  ...
  ['personal_vehicle']                = 'Persönliches Job-Fahrzeug',
  ...
  ['the_boss']                        = 'boss',
  ['vehicle']                         = 'Job-Fahrzeug ',
  ['vehicle_dealer']                  = 'Job-Autohändler',
  ['vehicle_menu']                    = 'Drücke ~INPUT_CONTEXT~ um ein Fahrzeug zu übergeben',
  ['vehicle_purchased']               = 'du hast ein Job-Fahrzeug gekauft',
  ...
  ['yes']                             = 'ja',
  ['deposit_stock']           = 'Sachen lagern',
  ['take_stock']              = 'Sachen mitnehmen',
  ['dealership_stock']        = 'Autohändler Lager',
  ['amount']                  = 'Anzahl',
  ['quantity_invalid']        = 'Ungültige Anzahl',
  ['inventory']               = 'Inventar',
  ['dealership']              = 'Job-Autohändler',
  ['dealer_customers']        = 'Authändler Kunde',
