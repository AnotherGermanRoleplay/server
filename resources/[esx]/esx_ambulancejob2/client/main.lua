  ...
  if IsDead and Config.ShowDeathTimer then
    ...
    Citizen.CreateThread(function()
      ...
      while timer > 0 and IsDead do
        ...
        if Config.EarlyRespawn and Config.EarlyRespawnFine and (enoughMoney or PlayerData.job.name == 'ambulance') then
          SetTextFont(4)
          ...
          SetTextEntry("STRING")
    		  ...
    		  -- show other death message to medics
    		  if PlayerData.job.name == 'ambulance' then
      			AddTextComponentString(_U('please_wait') .. minutes .. _U('minutes') .. seconds .. _U('seconds_fine') .. "0" .. _U('press_respawn'))
    		  else
