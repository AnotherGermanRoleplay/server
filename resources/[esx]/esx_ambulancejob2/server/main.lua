...
TriggerEvent('esx_society:registerSociety', 'ambulance', 'Notdienst', 'society_ambulance', 'society_ambulance', 'society_ambulance', {type = 'public'})
...
ESX.RegisterServerCallback('esx_ambulancejob:removeItemsAfterRPDeathRemoveMoney', function(source, cb)
  ...
  if Config.EarlyRespawn and Config.EarlyRespawnFine and xPlayer.job.name ~= 'ambulance' then
    xPlayer.removeAccountMoney('bank', Config.EarlyRespawnFineAmount)

    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_ambulance', function(account)
      account.addMoney(Config.EarlyRespawnFineAmount)
    end)
  end
