...
function OpenBusActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bus_actions',
    {
      title = 'Bus',
      elements = elements
    },
...
function OpenMobileBusActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_bus_actions',
    {
      title = 'Bus',
      elements = {
