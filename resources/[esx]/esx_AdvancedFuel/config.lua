...
settings["de"] = {
	openMenu = "Drücke ~g~E~w~ um das Menü zu öffnen.",
	electricError = "~r~Du hast ein Elektro-Fahrzeug.",
	fuelError = "~r~Du bist nicht am richtigen Ort.",
	buyFuel = "tanken",
	liters = "Liter",
	percent = "Prozent",
	confirm = "Bestätigen",
	fuelStation = "Tankstelle",
	boatFuelStation = "Tankstelle | Boot",
	avionFuelStation = "Tankstelle | Fulgzeug",
	heliFuelStation = "Tankstelle | Helikopter",
	getJerryCan = "Drücke ~g~E~w~ um einen Benzinkanister zu kaufen ("..petrolCanPrice.."$)",
	refeel = "Drücke ~g~E~w~ um das Auto zu tanken.",
	YouHaveBought = "Du hast gekauft ",
	fuel = " Liter Benzin",
	price = "Preis"
}
