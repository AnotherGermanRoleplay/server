ESX = nil
sharedAccountName = 'society_police'
...
function renderPrice()
    for i=0,34 do
        if(randomPrice) then
            StationsPrice[i] = math.floor(math.random(65,350))/100
        else
