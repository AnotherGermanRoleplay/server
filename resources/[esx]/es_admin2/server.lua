	...
	if args[1] then
		if(GetPlayerName(tonumber(args[1])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chatMessage', player, "SYSTEM", {255, 0, 0}, "Du wurdest von dem Admin ^2 " .. GetPlayerName(source) .. "^0 geslapped")
				TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Der Spieler ^2" .. GetPlayerName(player) .. "^0 wurde geslapped")
			end)
		else
			TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Incorrect player ID!")
		end
		...
		if(GetPlayerName(tonumber(args[1])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				if(target)then
					...
					TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Teleportiert zum Spieler: ^2" .. GetPlayerName(player) .. "")
				end
			end)
		else
			TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Incorrect player ID!")
...
TriggerEvent('es:addCommand', 'die', function(source, args, user)
	...
	TriggerClientEvent('chatMessage', source, "", {0,0,0}, "^1^*Du hast Selbstmord begangen.")
end, {help = "Suicide"})
	...
	if args[1] then
		if(GetPlayerName(tonumber(args[1])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chatMessage', player, "SYSTEM", {255, 0, 0}, "Du wurdest von einem Admin")
				TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Sieler ^2" .. GetPlayerName(player) .. "^0 wurde getötet.")
			end)
		else
			TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Incorrect player ID!")
		end
	...
	if args[1] then
		if(GetPlayerName(tonumber(args[1])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Spieler ^2" .. GetPlayerName(player) .. "^0 wurde gecrashed.")
			end)
		else
			TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Incorrect player ID!")
		end
