...
AddEventHandler('eden_garage:pay', function()
	...
	TriggerClientEvent('esx:showNotification', source, 'Du bezahlst  ~g~$' .. Config.Price)
...
AddEventHandler('eden_garage:payhealth', function(price)
	...
	TriggerClientEvent('esx:showNotification', source, 'Du bezahlst ~g~$' .. price .. '~w~ für die Reparatur.')
